...
<body>
    <form action="home/handle_forgotpws" method="post">
        <div class="content">
            <div class="wrapper">
                <div class="register--content">
                    ...
                    <div class="email">
                        <input type="text" name="username" class="inputText" required />
                        <span class="floating-label">Vui lòng điền tên đăng nhập</span>
                    </div>

                    <input type="submit" class="register-buttton" value="Gửi mã xác thực" name="register">
                    <div class="login--button">
                        <span>Tiếp tục đăng nhập</span>
                        <a class="btn" data-popup-open="register-popup" href="home/login">Đăng nhập</a>
                    </div>
                </div>
            </div>
        </div>
